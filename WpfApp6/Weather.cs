...
namespace WpfApp6
{
    class Weather : DependencyObject
    {
        ...
        public int Precipitation
        {
            ...
            //set
            //{
            //    if (presencePrecipitation == 0)
            //    {
            //        skyPrecipitation = "Cолнечно";
            //    }
            //    else if (presencePrecipitation == 1)
            //    {
            //        skyPrecipitation = "Облачно";
            //    }
            //    else if (presencePrecipitation == 2)
            //    {
            //        skyPrecipitation = "Дождь";
            //    }
            //    else if (presencePrecipitation == 3)
            //    {
            //        skyPrecipitation = "Снег";
            //    }
            //    else if (presencePrecipitation < 0 && presencePrecipitation > 3)
            //    {
            //        skyPrecipitation = "Не определлено";
            //    }
            //}
            set
            {
